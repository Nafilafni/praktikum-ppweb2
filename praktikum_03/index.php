...
<body>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <span id="fullnameHelpBlock" class="form-text text-muted">isi dengan nama lengkap kamu</span>
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <span id="messageHelpBlock" class="form-text text-muted">isi dengan keperluan kamu</span>
    </div>
  </div> 
  <div class="form-group row">
